...
quizApp = {
  ...
  implementations: {
    ...
    'sorting' : "lib/exercises/sorting.js",
    'pairs' : "lib/exercises/pairs.js",
    'multipleChoice': "lib/exercises/multipleChoice.js",
    'pictures': "lib/exercises/pictures.js",
    'youtube': "lib/exercises/youtube.js",
    'preload': "lib/exercises/preload.js",
    'report': "lib/exercises/report.js",
...
function quizApp_url(uriPath) {
  if (uriPath && (uriPath.indexOf("http://")==0 || uriPath.indexOf("https://"==0))) {
    return uriPath; // unchanged...
  }
  return (quizApp.baseUrl) ? quizApp.baseUrl + uriPath : uriPath;
}
